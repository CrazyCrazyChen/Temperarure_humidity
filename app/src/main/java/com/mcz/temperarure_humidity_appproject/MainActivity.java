                ...
                if (!servicesinfo.equals("null")){
                    ...
                    for (int j = 0; j < jsa.length(); j++) {
                      ...
                      dataInfo.setDevicetemperature(jsonObject.optString("Temperature"));
                        ...
                        dataInfo.setLight_LUX(jsonObject.optString("LightLUX"));    //光敏值
                    ...
                    for (int j = 0; j < jsa.length(); j++) {
                        ...
                        //dataInfo.setDevicelight2(jsonObject.optString("LightLED")); //光敏板led
            ...
            //    dataInfo.setDeviceType(object.optString("deviceType"));//model  deviceType
                ...
                if (!servicesinfo.equals("null")){
                    ...
                    for (int j = 0; j <  jsa.length(); j++) {
                        ...
                        dataInfo.setLight_LUX(jsonObject.optString("LightLUX"));
                       // dataInfo.setLight_LUX("99");
                      //  dataInfo.setDevicelight2(jsonObject.optString("LightLED"));
