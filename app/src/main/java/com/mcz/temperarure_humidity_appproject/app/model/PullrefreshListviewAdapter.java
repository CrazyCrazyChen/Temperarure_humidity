...
public class PullrefreshListviewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            vh.tv_lightlux = (TextView) convertView.findViewById(R.id.lightinlux);     //光照强度字段绑定布局反射
...
//                String gatewayId = mlist.get(position).getGatewayId();
       ...
       vh.temperature.setText(info.getDevicetemperature());//设置数据temperature  textvview温度设置
        ...
        vh.tv_lightlux.setText(info.getLight_LUX());        //textview光强度设置
     //   vh.tv_lightlux.setText("99");     //接收设置值的位置


        ImageView trash=(ImageView)convertView.findViewById(R.id.trash);        //设备删除逻辑
        ...
        Switch aSwitch=(Switch)convertView.findViewById(R.id.switch1);      //开关1操作逻辑
...
private Handler handler=new Handler()
{
    ...
    class ViewHolder{
        ...
        TextView tv_stutas;     //设备状态
        TextView tv_Devicehumidity,temperature;     //温湿度
        SwipeLayout swipeLayout;        //list布局id

        TextView tv_lightlux;          // 光照强度字段
